...
public class CharacterPickUp : MonoBehaviour {
	...
	void Start () {
		...
		characterPicked = StaticVariables.characterID; // 0;
    ...
    public void PickCharacter(int charNum)
    {
        ...
        characterIcon.sprite = characterIcons[charNum];
...
//	}
	...
	public void ChangeCharacterDetail(int characterNumber) {
		...
		charValue.text = hp.ToString("F0") + "\n" + mp.ToString("F0") + "\n" + speed.ToString("F0") + "\n" + CD.ToString("F0") + "\n" + attack.ToString("F0") + "\n" + defense.ToString("F0");
		totalValue.text = hp.ToString("F0") + "\n" + mp.ToString("F0") + "\n" + speed.ToString("F0") + "\n" + CD.ToString("F0") + "\n" + attack.ToString("F0") + "\n" + defense.ToString("F0");
		...
		expBarTransform.sizeDelta = new Vector2 (currentExp/maxExpForThisLevel * 130, expBarTransform.sizeDelta.y);
