...
{
public:
	// UnityEngine.GameObject DestroyByBoundary::explosion
	GameObject_t1756533147 * ___explosion_2;

public:
	inline static int32_t get_offset_of_explosion_2() { return static_cast<int32_t>(offsetof(DestroyByBoundary_t3535450619, ___explosion_2)); }
