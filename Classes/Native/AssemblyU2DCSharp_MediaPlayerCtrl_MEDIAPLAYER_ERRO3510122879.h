...
struct  MEDIAPLAYER_ERROR_t3510122879 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(MEDIAPLAYER_ERROR_t3510122879, ___value___1)); }
