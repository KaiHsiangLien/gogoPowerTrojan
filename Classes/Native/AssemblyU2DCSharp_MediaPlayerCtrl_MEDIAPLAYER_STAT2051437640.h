...
struct  MEDIAPLAYER_STATE_t2051437640 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(MEDIAPLAYER_STATE_t2051437640, ___value___1)); }
